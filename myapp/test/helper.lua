    ...
    replicasets = {
        {
            ...
            roles = {'vshard-router','Api','Task-Get_BTC_Rates'},
            servers = {
        ...
        },
        {
            ...
            roles = {'vshard-storage', 'Storage'},
            servers = {
                { instance_uuid = cartridge_helpers.uuid('d', 1), alias = 'storage1' },
                --{ instance_uuid = cartridge_helpers.uuid('g', 1), alias = 'storage2' },
            },
        },
    }
})
